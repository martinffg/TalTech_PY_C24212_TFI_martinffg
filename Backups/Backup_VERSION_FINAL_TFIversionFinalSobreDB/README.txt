######## Archivo README para el  Repositorio Personal del PFI de Martin Fernandez Gamen - 2024 - Curso Python Inicial Talento Tech - Comision 24212 ########
...
### FORMATO DE ENTREGA: 
* CREAR UNA CARPETA EN DRIVE (PÚBLICA) QUE CONTENGA LOS ARCHIVOS Y CARPETAS QUE CONFORMAN TU PROYECTO.
* CÓDIGO COMPLETO PUBLICADO EN GITHUB 

### Instrucciones para el uso del programa:

* El archivo principal donde se debe desarrolla el código del programa se llama "app_main.py". Todo el trabajo se realizó dentro de este archivo como fue requerido.
